...
function Navbar() {
  ...
  return (
    ...
    <div><button onClick={(e) => handleCreateBoard(e)} className='border border-green-500 w-fit p-1 px-2 text-slate-50 rounded-lg hover:bg-green-500 hover:text-slate-800'>Create Board</button></div>
